 ...
 */
public abstract class A_Solver_Extended<TSymbolicString extends A_Model<TSymbolicString>> {
    ...
    public A_Solver_Extended() {
    }

    public A_Solver_Extended(int initialBound) {
